...
const TemaPresentacion: React.FC<TemaPresentacionProps> = ({
  unit,
  tema,
  mode = 'embedded'
}) => {
    ...
    () => [
      {
        ...
        content: (
          <div className="space-y-6 text-center">
            <div
              className={`inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold ${styles.badge}`}
            >
